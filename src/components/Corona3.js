...
const Corona3 = () => {
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <Link class="page-link" to="/corona2" tabindex="-1">Previous</Link>
    </li>
    <li class="page-item"><Link class="page-link" to="/corona2">1</Link></li>
    <li class="page-item"><Link class="page-link" to="/corona3">2</Link></li>
